...
#let subSection(title: none, titleEnd: none, subTitle: none, subTitleEnd: none, content: []) = {
...
#let project(
  ...
  let formattedName = block(upper(text(2.25em, weight: "bold", theme, name)))

  let formattedTitle = block(upper(text(1.75em, gray.darken(50%), title)))
